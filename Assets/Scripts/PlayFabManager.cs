...
public class PlayFabManager : MonoBehaviour
{
    ...
    {
        // Call the ForgetAllCredentials() method to clear cached login information
        PlayFabClientAPI.ForgetAllCredentials();

        // You can also optionally show a message to the player indicating that they have been signed out
        Debug.Log("You have been signed out.");
